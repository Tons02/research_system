...
class ResponseClassDE implements FromCollection, WithMapping, WithHeadings, WithTitle, WithEvents, WithStyles
{
    ...
    public function collection()
    {
        ...
        $data = QuestionAnswer::query()
            ...
            ->where('question_answers.monthly_utility_expenses', 'Class DE')
    ...
    {
        return 'SURVEY RESPONSES CLASS DE';
    }
